...
def test_get_popular_events_multiple_events(mock_build_service):
...
@patch("src.services.event.build_service")
def test_get_popular_events_no_events(mock_build_service):
...
@patch("src.services.event.build_service")
def test_get_popular_events_single_event(mock_build_service):
    # Mock the service and its methods
    mock_service = MagicMock()
    mock_build_service.return_value = mock_service
...
@patch("src.services.event.build_service")
def test_get_popular_events_more_than_ten_unique_events(mock_build_service):
    # Mock the service and its methods
    mock_service = MagicMock()
    mock_build_service.return_value = mock_service
